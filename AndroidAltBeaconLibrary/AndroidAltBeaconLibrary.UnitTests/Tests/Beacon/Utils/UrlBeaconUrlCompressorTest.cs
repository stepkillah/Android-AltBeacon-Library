    ...
    public class UrlBeaconUrlCompressorTest : TestBase
    {
        ...
        public void testCompressURL()
        {
            ...
            byte[] expectedBytes = {0x00,
                ...
                Convert.ToByte('s'),
                0x07};
            Arrays.Equals(expectedBytes, UrlBeaconUrlCompressor.Compress(testURL));
        }
        ...
        public void testCompressHttpsURL()
        {
            ...
            Convert.ToByte('r'),
                ...
                Convert.ToByte('s'),
                0x07};
            AssertEx.True(Arrays.Equals(expectedBytes, UrlBeaconUrlCompressor.Compress(testURL)));
        }
        ...
        //    AssertEx.AreEqual(testURL, UrlBeaconUrlCompressor.Uncompress(testBytes));
        //}
